...
Wayland, and X11 application/window lifecycles into `mulciber-platform`; the full Metal and Vulkan
probes are executable consumers while Win32 and graphics extraction continue.
