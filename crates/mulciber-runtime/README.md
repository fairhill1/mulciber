...
scoped input transitions, and rendering suspend/resume coordination over `mulciber-platform`. New in
0.2.0, presented-cadence pacing diagnostics consume drained presentation feedback into cadence
estimates, interval distributions, and missed-interval counts. The crate does not yet own the native
event pump, pacing policy, process/OS suspension, display transitions, jobs, or device recovery.
