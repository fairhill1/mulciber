//! Self-contained geometry, texture, and transform data for the postprocess cube.
...
pub(crate) fn transform(seconds: f32, aspect: f32) -> [[f32; 4]; 4] {
    let model = Mat4::from_rotation_y(seconds * 0.85) * Mat4::from_rotation_x(seconds * 0.47);
