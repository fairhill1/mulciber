...
- [x] Establish baseline, optional-capability, invalid-usage, surface-generation, frame-abandonment,
  ...
  tests: `probes/api-conformance` currently asserts thirty-four cases across those categories (plus the
  ...
  per-slot filter and address modes backed by pipeline-owned native samplers; and material
  ...
  the [decision ledger](api-slice-decisions.md).
