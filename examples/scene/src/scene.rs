//! Geometry, texture, and transform data for the multi-object pressure scene.
...
pub(crate) const PYRAMID_VERTICES: [Vertex; 5] = [
...
pub(crate) const PYRAMID_INDICES: [u16; 18] = [
    0, 2, 1, 0, 3, 2, // base
    0, 1, 4, 1, 2, 4, 2, 3, 4, 3, 0, 4,
];

pub(crate) fn checkerboard(a: [u8; 3], b: [u8; 3]) -> [u8; 8 * 8 * 4] {
...
pub(crate) fn transforms(seconds: f32, aspect: f32) -> Vec<[[f32; 4]; 4]> {
